<nav x-data="{ open: false }" class="bg-white/80 backdrop-blur-md shadow-soft border-b border-secondary-200/50 sticky top-0 z-50">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center group">
                        ...
                        <span class="text-2xl font-bold bg-gradient-to-r from-secondary-900 to-primary-700 bg-clip-text text-transparent">
                            {{ $siteName }}
                        </span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- Blog Dropdown (clonado del dropdown usuario) -->
                    <div class="hidden sm:flex sm:items-center">
                        <x-dropdown align="left" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('blog.index')" target="_blank">
                                    {{ __('Ver Blog') }}
                                </x-dropdown-link>
                                ...
                                <x-dropdown-link :href="route('moderation.index')">
                                    {{ __('Moderación') }}
                                </x-dropdown-link>
                    ...
                    @if(auth()->user()->canModerate())
                    <!-- Sistema Dropdown (clonado del dropdown usuario) -->
                    <div class="hidden sm:flex sm:items-center">
                        <x-dropdown align="left" width="48">
                            <x-slot name="trigger">
                                <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('blog.index')" target="_blank">
                {{ __('Ver Blog') }}
            </x-responsive-nav-link>
        </div>
