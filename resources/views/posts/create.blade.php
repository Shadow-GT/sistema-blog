...
@section('title', 'Crear Post - Nuevo Artículo')
        ...
        <div class="mb-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p class="text-xl text-secondary-600 mt-2">Escribe y publica tu nuevo artículo</p>
                </div>
            ...
            <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data" class="p-8 space-y-8">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-secondary-500 mt-2">Se generará automáticamente desde el título si se deja vacío</p>
                    </div>
                ...
                <div class="space-y-6">
                    <div class="border-b border-secondary-200 pb-4">
                        ...
                        <p class="text-secondary-600 text-sm mt-1">Escribe el contenido principal de tu artículo</p>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="excerpt" id="excerpt" rows="3"
                                  ...
                                  placeholder="Escribe un breve resumen de tu post (opcional)">{{ old('excerpt') }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea name="content" id="content" rows="15"
                                  class="w-full px-4 py-3 border border-secondary-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200"
                                  placeholder="Escribe aquí el contenido completo de tu post...">{{ old('content') }}</textarea>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select name="status" id="status"
                                ...
                                <option value="pending" {{ old('status') === 'pending' ? 'selected' : '' }}>⏳ Pendiente de Revisión</option>
